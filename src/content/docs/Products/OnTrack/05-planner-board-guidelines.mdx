...
<Steps>
  <ol>
    <li>
      Open the Planner Board for your sprint. Click on <strong>Add Task</strong>{" "}
      and provide a clear title and description. Assign the task to a team
      member and set a due date. ![Overview of Planner Boards](images/moving.png
      "Planner Board Overview")
    </li>
    <li>
      Drag and drop task cards to the appropriate column (*To Do*, *In
      Progress*, *Review*, *Done*). Update the card’s status whenever
      significant progress is made. ![Overview of Planner
