...
Docker Desktop and follow this guide from the beginning to avoid configuration issues.
...
Required Repositories: a) `doubtfire-deploy`
...
Note: The version number (`10.0.0-14`) comes from the `docker-compose.yaml` file in the
