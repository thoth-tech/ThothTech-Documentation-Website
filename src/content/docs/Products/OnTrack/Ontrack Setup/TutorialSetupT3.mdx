...
If you have attempted the setup previously and encountered errors.
It is recommended to restart Docker Desktop
Follow this guide from the beginning to avoid configuration issues.
