...
<Tabs>
  <TabItem label="Website">
    ...
    <LinkCard
      ...
      href="/products/splashkit/documentation/splashkit-website/usage-examples/01-overview"
    />
    <LinkCard
      title="Style Guide for Usage Examples"
      description="A guide on code syntax and formatting required for usage examples for SplashKit"
  ...
  <TabItem label="Online">
    <LinkCard
      ...
      description="A guide on how to get started creating usage examples for SplashKit"
      href="/products/splashkit/documentation/splashkit-online/"
    />
  </TabItem>
  <TabItem label="Core">
    <LinkCard
      ...
      href="/products/splashkit/documentation/splashkit-expansion/"
    />
  </TabItem>
</Tabs>
---
...
Collaboration is key to maintaining high standards. These guides cover how to
conduct peer reviews, including the things to look for and how to provide
...
<LinkCard
  ...
  href="/products/splashkit/documentation/splashkit-website/website-documentation/05-peer-review-web"
/>
<LinkCard
  title="Peer Review Guide for Usage Examples"
  description="A peer review guide specifically for usage examples tasks."
  href="/products/splashkit/documentation/splashkit-website/usage-examples/04-usage-peer-review"
/>

## Additional Resources

As you settle into your role, you'll need to understand how to use the team's
planner board effectively. This guide provides guidelines for using the planner
board to track tasks, manage the planner cards and work efficiently:
