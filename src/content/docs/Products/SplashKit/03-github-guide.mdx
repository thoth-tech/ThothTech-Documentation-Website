...
First step is to ensure you have the necessary tools installed on your workspace. Follow the guide in the [setting up](/products/splashkit/02-setting-up) section and then proceed to step 2
...
- Find the Repository:
  ...
  - [SplashKit Online repository](https://github.com/thoth-tech/SplashkitOnline).
...
<Aside>
SplahKit Core cloning is slightly different! Make sure you follow the right method below
</Aside>
<Tabs>
...
- [Online](https://github.com/thoth-tech/SplashkitOnline/blob/main/README.md)
...
A lot can go wrong when working within repositories, the following guide contains a few troubleshooting steps you can take to resolve the most common issues.

<Aside type="tip">
You can also check the [GitHub Git Cheat Sheet.](https://education.github.com/git-cheat-sheet-education.pdf)
</Aside>
