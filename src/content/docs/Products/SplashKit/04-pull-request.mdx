...
Creating a pull request for Usage examples contains additional steps which can be found in the usage
example tab [here](/products/splashkit/05-pull-request-template/)
