...
Creating a pull request for Usage examples contains additional steps which can be found
[here](/products/splashkit/projects/splashkit-website/usage-examples/03-usage-pull-request)
