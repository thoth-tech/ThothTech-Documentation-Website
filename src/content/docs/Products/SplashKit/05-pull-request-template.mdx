...
[Usage Example Overview](/products/splashkit/documentation/splashkit-website/usage-examples/01-overview)
guide for creating a usage example. Ensure you have the files listed below added, with their names
updated to the function you are demonstrating.
...
steps on the [pull request guide](/products/splashkit/04-pull-request), however, the destination
branch needs to be changed to be **usage-examples**.
