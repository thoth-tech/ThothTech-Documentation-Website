...
10. ### Update Planner Board Status
    ...
    Following the
    [Planner Board Etiquette](/products/splashkit/08-planner-board),
...
- **Usage Example Styling Guide**: [Style Guide](/products/splashkit/projects/splashkit-website/usage-examples/05-usage-example-style-guide)
