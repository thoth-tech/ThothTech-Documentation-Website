...
[here](/products/splashkit/projects/splashkit-website/usage-examples/04-usage-peer-review)
...
1.  ### Check for Upstream Branches
    ...
    Start by verifying whether the upstream branches are already added to your local repository.
    This is necessary to ensure that you can fetch PRs from the original repository for review.
