...
compiled into `skunit_tests`. See the [unit testing guide](/products/splashkit/documentation/splashkit-expansion/01-unit-testing-guide) for a more in depth explanation of how unit tests are written.
