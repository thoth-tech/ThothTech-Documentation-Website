...
The `unit_test_<name>.cpp` files contain tests for related parts of SplashKit.
...
3. Configure the extension:  
   ...
   ![Build target button](images/build-unit-tests/select-target.png) next to
   Build and select skunit_tests  
   ![Select build target](images/build-unit-tests/3-target-unit-tests.png)  
   Click the button
   ![Select Default preset](images/build-unit-tests/select-target.png) next to
