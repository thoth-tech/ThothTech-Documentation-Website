...
Note that currently code coverage reports won't display properly with versions of the CMake Tools extension 1.21.36 and beyond. To work around this, you can install an older version of the extension by clicking the arrow next to Install/Uninstall (depending on if you have CMake Tools installed already) and selecting "Install Specific Version...". The latest version known to work is 1.20.53.
