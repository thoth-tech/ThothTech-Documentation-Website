...
3. ### Write the Program in Multiple Languages
   ...
   - **C++**: Implement the example with standard C++ practices, providing a version using SplashKit
     ...
     > **Note:** [Beyond SplashKit](https://splashkit.io/beyond-splashkit/projects/) is designed to support
...
7. ### Submit a Pull Request for Usage Examples
   ...
   [Pull Requests for Usage Examples guide](/products/splashkit/projects/splashkit-website/usage-examples/03-usage-pull-request).
