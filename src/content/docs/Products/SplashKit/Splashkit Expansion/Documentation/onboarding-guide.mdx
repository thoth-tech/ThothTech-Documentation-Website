...
which can be adjusted for splashkit-core by substitutung repository names:
...
providing contructive feedback. This process has been detailed in the following guide:
...
following guide details the procedure and ettique which is expected while using the planner board:
