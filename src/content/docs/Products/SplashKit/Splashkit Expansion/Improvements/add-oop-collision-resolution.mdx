---
title: Adding OOP Principles to the Shape Types, Simplifying Collision Classification and Resolution Functions
sidebar:
  label: Adding OOP Principles to the Shape Types, Simplifying Collision Classification and Resolution Functions
  order: 1
---
