...
[here](https://splashkit.io/api/terminal/#write-line-2), clicking on the `See Code Example` shows how the `write_line`
function works, with a brief title of the program, program code, and a screenshot of the output.
