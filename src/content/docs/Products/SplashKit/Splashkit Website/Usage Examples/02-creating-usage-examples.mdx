...
1. ### Choosing a Function
   ...
   [API Documentation](https://splashkit.io/api/) to find various functions you could use for
...
4. ### Adding these files to Splashkit Starlight.io
   ...
   increment the number in the file name by 1. Furthermore, it is important that you use the
   function's unique global name for the files names _(This only applies for functions that are
   overloaded.)_
   ...
   For more information regarding the proper file naming and placement can be found within the repo
   in the `CONTRIBUTING.mdx`. The location of the file can be found here:
