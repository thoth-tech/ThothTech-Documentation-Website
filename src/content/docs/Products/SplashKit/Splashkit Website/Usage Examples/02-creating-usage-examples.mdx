...
![splashkit repo](./images/usageexample2.png)
...
4. ### Adding these files to Splashkit Starlight.io
   ...
   increment the number in the file name by 1. Furthermore, it is important that you use the function's unique global name for the files names *(This only applies for functions that is overloaded.)*

   Now that your files are named, add all of your files to the `usage-examples` folder under
   the appropriate function category (e.g., `terminal/`). The location in the
