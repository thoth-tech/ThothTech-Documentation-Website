...
:::tip[Python function names] Python function names will often differ from other languages due to
python not handling function overloads. The example above shows the difference for this overload of
Refresh Screen.

You can check the correct function signature in the API Documentation pages. :::
