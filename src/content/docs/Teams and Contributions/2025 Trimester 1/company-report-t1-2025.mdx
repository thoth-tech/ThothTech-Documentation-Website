...
- Updated *clear_screen* usage example
- Created usage example for *text_width* function
...
- Expanding support for C#. This includes adding methods for *DrawPixl* to window class
