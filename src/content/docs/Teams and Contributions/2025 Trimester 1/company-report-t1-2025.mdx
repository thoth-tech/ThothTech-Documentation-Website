...
|----------------------------------------------|----------------------------------------------------------------|----------------|
| ELIYA BARRYVETCH GEERLINGS                    | Self-Enrolment Feature Lead                                     | Senior         |
...
| CHEE YU KOH                                   | UI Wireframes & Review Leader                                   | Senior         |
| TEHAN ROZARIO                                 | Unit Filtering and Display Optimization                         | Senior         |
| ANMOL SANI                                    | Testing Support & Review Contributions                          | Senior         |
...
| SAMINDI SITUYMA RATNAYAKE MUDIYANSELAGE       | CSV Import/Export, Planner & Grant Extensions – Project Lead    | Junior         |
...
| NAIDAPPUALGE PASINDU KAUSHALYA FERNANDO       | Analytics Virtual Pageview Cleanup                              | Junior         |
| DISURU PASANITH RATHNAYAKE RATHNAYAKE THUDUGALA BANDULAGE | Task Route Migration                                | Junior         |
| HASINDU DESHANTHA WELARATHNE                  | Unused Debug Module Cleanup                                     | Junior         |
...
| JOE WASAKI MACLEAN                            | Grant Extension Form – Frontend Implementation                  | Junior         |
...
| Atharv Sandip Bhandare                                     | Reviewer         | Migrate media-service.coffee                                                                                                    | https://github.com/thoth-tech/documentation/pull/580 https://github.com/thoth-tech/doubtfire-web/pull/284 |
...
| Atharv Sandip Bhandare                                     | Main Contributor      | AppAttack x OnTrack Contract                                                                                                    | https://github.com/thoth-tech/doubtfire-astro/pull/27                                                     |
...
#### SplashKit Expansion
- Many of the SK Expansion tasks are currently still in-developement as noted below. This is due to the larger scope of each tasks and ensuring that each tasks quality is up to the standard we strive for.
