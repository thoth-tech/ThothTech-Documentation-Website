...
- *Patching of critical issues* is planned to begin in *Week 7*, with task assignments managed via Microsoft Teams Planner.
- The objective is to patch all severe and major issues, coordinate a follow-up retest, and submit the final report by *12 May 2025*.
...
- Currently working on enhancing the script for *scalability and integration with Burp Suite*.
...
To support the implementation of the Staff Grant Extension feature, a series of granular backend and frontend tasks have been outlined in the project planner. These include database schema design, authentication integration, API development, and user interface construction for both staff and student views.

While the overall progress is ongoing, we can confirm that the *UI wireframes and user flow for the extension management interface* have been completed. This forms a foundational part of the frontend experience, enabling staff to grant, edit, and view student extensions.

Further development is expected to progress across related backend and frontend components, as outlined in the scoped task breakdown within the Teams planner
...
| Aditya Pratap Singh Tomer                                  | Reviewer         | Design Feature - Incorporate Content                                                                                            |                  |
...
#### SplashKit Expansion
- No completed pull requests have been merged yet.

#### SplashKit Website
- A significant overhall has been completed on API's page links. This overhall has significantly improved the user experience on the Splashkit website by finding more context relevant examples.
- The SplashKit Usage Example documentation has been updated to match the current workflow process, this updates have contributed to a smoother and more efficient contributing experience.
- THe `CONTRIBUTING.MDX` file has also been updated to include new information and improve clarity. 
- Several Beyond SplashKit examples been created, which guides users on how to program efficiently without the use of the SplashKit SDK. #### SplashKit Online
- Refactored css to elimate technical deficit. This has improved the developer experience by eliminating duplication in the code base making it easier to work on and layed the ground work for more features to be added later in development.

### In Development Tasks

#### SplashKit Expansion
- Exapanded unit_test_utitlies.cpp to cover all functions basics.cpp. This will significantly improve the developer experience during the testing of new features.
- Bug fixes in the cmake function for splashkit core. Fixing this bug has imporved the developer experience on Windows.
- Create a unit testing guide. This will speed will speed up the onboarding process for junoir when they are joining the project. Additionally it will stanardise the unit tests improving the effiency of writing tests in the future.
- Improvements to the unit testing workflow which will improve the developer experience with regards to unit testing.
- Expanding support for C#. This includes adding methods for *DrawPixel* to window class which is contributing to a more complete developer experience in this langauge.
- Swapping over the RPi library in splashkit core from pigpio to WiringPi. This will improve the developer experience by updating this depedency to a more modern alternative.

#### SplashKit Website
- Adding Python code in using animation tutorials which will help students work with animation in python.
- Updated the Script to add usage examples function. This is working with the previously made change to the API. This has improved the efficency of such scripts with the site now being able to find uses of a function efficently.
- Adding a "*" next to every function that has a usage example. This will allow for more efficent navigation for users.
- Addition of significant useage to the following sections on the Splashkit website. These catergories are: Graphics, Geometery, Audio which will improve the accessiablity and user experience when using Splashkit.
- Updating the guidelines for usage examples for the SplashKit website. This will increase the quality of all new examples which will improve user experience.
- Updating the SplashKitOnline Astro Component, which will allow for easier intergration of Splashkit Online with the SplashKit website.
- Addition of tutorials on using Pulse Width Modulation (PWM) with regards to controlling LEDs and buttons which will help students work with SplashKit for controlling PWM.



#### SplashKit Online
- Support for C# as a langauge option (beta). This includes updates to api.json, reading and processing api.json and generating C# bindings on C# and Javascript sides. This will allow for a complete C# development experience and better developer experience when completed.
- Overhalling of the current documentation of the project. Since the current documentation is lacking, this overhall will make the onboarding process and adding new features significantly easier.
...
|-------------------------|-----------------------------------------------------------------|----------------------------------------------------------------------|
|Cameron Stewart Humphries|Refactor CSS and HTML to support theming and later mobile support|https://github.com/thoth-tech/SplashkitOnline/pull/116                |
...
|Daniel Carroll-Leonard   |Line from (start with offset) - Geometry - Usage Example Creation|https://github.com/thoth-tech/splashkit.io-starlight/pull/364         |
|Daniel Carroll-Leonard   |Display X - Graphics - Usage Example Creation                    |https://github.com/thoth-tech/splashkit.io-starlight/pull/356         |
|Dhruv Janghu             |Stop Music - Audio - Usage Example Creation                      |https://github.com/thoth-tech/splashkit.io-starlight/pull/417         |
|Dhruv Janghu             |Fill rectangle - Graphics - Usage Example Update                 |https://github.com/thoth-tech/splashkit.io-starlight/pull/394         |
...
|Ethan Rin                |Play Music - Audio - Usage Example Creation                      |https://github.com/thoth-tech/splashkit.io-starlight/pull/410         |
|Ethan Rin                |Fill Ellipse on Window - Graphics - Usage Example Creation       |https://github.com/thoth-tech/splashkit.io-starlight/pull/377         |
|Ethan Rin                |Text height - Graphics - Usage Example Creation                  |https://github.com/thoth-tech/splashkit.io-starlight/pull/360         |
|Josh Fernandes           |Display Name - Graphics - Usage Example Creation                 |https://github.com/thoth-tech/splashkit.io-starlight/pull/363         |
|Josh Fernandes           |Display Details - Graphics - Usage Example Creation              |https://github.com/thoth-tech/splashkit.io-starlight/pull/362         |
|Josh Fernandes           |Fill Ellipse on Window - Graphics - Usage Example Creation       |https://github.com/thoth-tech/splashkit.io-starlight/pull/377         |
|Julian Burton            |Text width - Graphics - Usage Example Creation                   |https://github.com/thoth-tech/splashkit.io-starlight/pull/361         |
|Julian Burton            |Draw Pixel on window - Graphics - Usage Example Creation         |https://github.com/thoth-tech/splashkit.io-starlight/pull/379         |
|Lam Quoc Huy Huynh       |Clear screen - Graphics - Usage Example Update                   |https://github.com/thoth-tech/splashkit.io-starlight/pull/374         |
|Lam Quoc Huy Huynh       |Fill rectangle - Graphics - Usage Example Update                 |https://github.com/thoth-tech/splashkit.io-starlight/pull/394         |
|Lam Quoc Huy Huynh       |Option Rotate Bmp - Graphics - Usage Example Creation            |https://github.com/thoth-tech/splashkit.io-starlight/pull/368         |
...
|Rachel Mei Alonzo Chu    |Update the API pages' link                                       |https://github.com/thoth-tech/splashkit.io-starlight/pull/378         |
|Rachel Mei Alonzo Chu    |Line from (start with offset) - Geometry - Usage Example Creation|https://github.com/thoth-tech/splashkit.io-starlight/pull/364         |
|Rachel Mei Alonzo Chu    |Display Height - Graphics - Usage Example Creation               |https://github.com/thoth-tech/splashkit.io-starlight/pull/366         |
|Rachel Mei Alonzo Chu    |Fill Ellipse on Window - Graphics - Usage Example Creation       |https://github.com/thoth-tech/splashkit.io-starlight/pull/377         |
|Rachel Mei Alonzo Chu    |Option Scale Bmp - Graphics - Usage Example Creation             |https://github.com/thoth-tech/splashkit.io-starlight/pull/372         |
|Rachel Mei Alonzo Chu    |Text height - Graphics - Usage Example Creation                  |https://github.com/thoth-tech/splashkit.io-starlight/pull/360         |
|Sam Stajnko              |Refactor CSS and HTML to support theming and later mobile support|https://github.com/thoth-tech/SplashkitOnline/pull/116                |
|Sam Stajnko              |Display Name - Graphics - Usage Example Creation                 |https://github.com/thoth-tech/splashkit.io-starlight/pull/363         |
|Sam Stajnko              |Draw Pixel on window - Graphics - Usage Example Creation         |https://github.com/thoth-tech/splashkit.io-starlight/pull/379         |
|Sam Stajnko              |Option Rotate Bmp - Graphics - Usage Example Creation            |https://github.com/thoth-tech/splashkit.io-starlight/pull/368         |
|Sam Stajnko              |Option Scale Bmp - Graphics - Usage Example Creation             |https://github.com/thoth-tech/splashkit.io-starlight/pull/372         |
|Simon Rhook              |Clear screen - Graphics - Usage Example Update                   |https://github.com/thoth-tech/splashkit.io-starlight/pull/374         |
|Simon Rhook              |Text width - Graphics - Usage Example Creation                   |https://github.com/thoth-tech/splashkit.io-starlight/pull/361         |
|Simon Rhook              |Update the API pages' link                                       |https://github.com/thoth-tech/splashkit.io-starlight/pull/378         |
|Simon Rhook              |Display Name - Graphics - Usage Example Creation                 |https://github.com/thoth-tech/splashkit.io-starlight/pull/363         |
|Simon Rhook              |Line from (start with offset) - Geometry - Usage Example Creation|https://github.com/thoth-tech/splashkit.io-starlight/pull/364         |
|Simon Rhook              |Play Music - Audio - Usage Example Creation                      |https://github.com/thoth-tech/splashkit.io-starlight/pull/410         |
|Simon Rhook              |Stop Music - Audio - Usage Example Creation                      |https://github.com/thoth-tech/splashkit.io-starlight/pull/417         |
|Simon Rhook              |Display Details - Graphics - Usage Example Creation              |https://github.com/thoth-tech/splashkit.io-starlight/pull/362         |
|Simon Rhook              |Display Height - Graphics - Usage Example Creation               |https://github.com/thoth-tech/splashkit.io-starlight/pull/366         |
|Simon Rhook              |Display X - Graphics - Usage Example Creation                    |https://github.com/thoth-tech/splashkit.io-starlight/pull/356         |
|Simon Rhook              |Fade Music In Named - Audio - Usage Example Creation             |https://github.com/thoth-tech/splashkit.io-starlight/pull/415         |
|Simon Rhook              |Fade Music Out - Audio - Usage Example Creation                  |https://github.com/thoth-tech/splashkit.io-starlight/pull/414         |
|Simon Rhook              |Load Music - Audio - Usage Example Creation                      |https://github.com/thoth-tech/splashkit.io-starlight/pull/413         |
|Simon Rhook              |Music Name - Audio - Usage Example Creation                      |https://github.com/thoth-tech/splashkit.io-starlight/pull/412         |
|Simon Rhook              |Option Rotate Bmp - Graphics - Usage Example Creation            |https://github.com/thoth-tech/splashkit.io-starlight/pull/368         |
|Simon Rhook              |Pause Music - Audio - Usage Example Creation                     |https://github.com/thoth-tech/splashkit.io-starlight/pull/411         |
|Simon Rhook              |Resume Music - Audio - Usage Example Creation                    |https://github.com/thoth-tech/splashkit.io-starlight/pull/409         |
|Simon Rhook              |Set Music Volume - Audio - Usage Example Creation                |https://github.com/thoth-tech/splashkit.io-starlight/pull/416         |
