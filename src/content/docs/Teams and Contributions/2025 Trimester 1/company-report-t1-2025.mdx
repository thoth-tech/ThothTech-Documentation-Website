...
- Create two new usage examples in the Graphics section of splashkit documentation. This includes the *clear_screen & text_width* functions. These updates will improve the beginer development experienceas both of these functionsa are commonly used.
