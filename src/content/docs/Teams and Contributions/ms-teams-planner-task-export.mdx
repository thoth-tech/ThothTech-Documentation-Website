...
window.onload = (e) => {
    const targetLink = 'https://thoth-tech.netlify.app/public/scripts/MSTeamsPlannerExportScript.py';
...
The script can be found [here](/public/scripts/MSTeamsPlannerExportScript.py). It's pretty simple to use, and for a step-by-step guide see below:
...
2. **Download and Run the Script**
    ...
    <Code code="curl -O https://thoth-tech.netlify.app/public/scripts/MSTeamsPlannerExportScript.py && python MSTeamsPlannerExportScript.py" lang="bash"></Code>

    This just downloads the Python script mentioned above, and runs it. The script doesn't require any additional dependencies, and _should_ work on any platform.
