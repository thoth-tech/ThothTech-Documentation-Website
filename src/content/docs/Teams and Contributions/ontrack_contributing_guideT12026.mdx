...
description: Complete workflow and onboarding guide for capstone contributors working on the OnTrack project.
---
...
git add .
git commit -m "Creating the folder for 2025 Trimester 3 in Teams and contributions"
