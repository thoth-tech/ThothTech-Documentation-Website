...
instance) or presentation of electives in the respective interfaces on the client side (which will allow for filtering based on specializations, teaching periods and years).
