...
| ------------- | -------------- | ----------------------------------------------- |
| courseId      | String         | Auto generated id.                              |
...
| Field         | Type           | Description                                     |
| ------------- | -------------- | ----------------------------------------------- |
| unitId        | String         | Auto generated id.                              |
...
(stored as a json object). Displaying the units correctly in their respective year, trimester and
positional slot will be handled by the front end by using the returned data.
