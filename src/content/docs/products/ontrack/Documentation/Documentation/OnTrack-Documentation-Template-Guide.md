...
template is included. That way, you can better understand the template in general.
...
it, or has some suggestions on the documentation itself, they know who to talk to.
...
Conversely, they can contact the author if the document ever needs
...
second point of contact. They could be contacted to get more information on
...
how old the document is, regardless of how many versions or iterations there are.
...
documentation they are reading. This could come in handy if the
reader needed to review a long-ago written (legacy) version, or if two versions
...
continuing accuracy. Depending on how often the data in the document may
...
could provide your reader with the background knowledge they need to gain the
best understanding of what you are trying to say. This might be particularly
helpful in technical documents, where a number of terms might need to be defined.
...
hyperlinks to webpages or even other Thoth Tech documents in GitHub to give
your reader necessary background information. Having these links at
the start of your documentation also saves the reader looking for them throughout
the entire document. With this background information and links, this list will
assist your reader in understanding what you have to say.
