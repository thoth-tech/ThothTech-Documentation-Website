...
error should be added to that team's version of this template. This way,
the team responsible for the document can be made aware of the error. The team
which the document relates to can then evaluate whether it must be fixed or not.
...
whose area is "Critical Issues" would replace "**_{Insert Team Here}_**"
...
2. Copy this template into the new file, _starting from the_ "**_{Insert Team
   ...
   Information on how to contribute to the template is also included below as well.
...
2. Copy the contents of the OnTrack Documentation Template into your new Spelling
   and Grammar file. The contents of the OnTrack Documentation Template should
   come before (precede) the contents of the Spelling and Grammar Template in
   your new file.
...
- Document File Path (in GitHub)
  - Most all of Thoth Tech's documentation can be found in it's GitHub
    ...
    file path of the OnTrack Documentation is: _documentation/docs/OnTrack/Documentation_.
...
has a [Markdown Guide](https://github.com/thoth-tech/handbook/blob/main/docs/learning/training/markdown-guide.md).
...
separated by a '|'. For example, the first entry of the above table, in Markdown,
 is therefore written like this:
...
- If you are not a member of the team to which this list belongs to, ensure you
  ...
  - You may not understand their workings and could hinder their progress if you
    ...
    their knowledge could have unforeseen consequences.
