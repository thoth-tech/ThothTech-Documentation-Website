...
verified at any stage in the current OnTrack implementation. Contract cheating
or other methods of cheating could be used, and would not be picked up by the
...
inputs, and produces a confidence variable with certainty of the speakers identity.
...
be retrieved by the system. This retrieval takes place when the file is requested
for marking.
