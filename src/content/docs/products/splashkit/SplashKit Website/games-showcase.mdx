...
The [Games Showcase Template](/products/splashkit/splashkit-website/games-showcase-template) is to be used when adding a game to the
Games Showcase on the SplashKit.io website. This will be included in the /src/content/docs/games
folder of the SplashKit.io folder.
...
:::tip An example may look like this:
...
To add a game to the front page swiper, you will need to edit the games-config.json folder found in
the src/components/react/GameCardSwiper folder.
...
- **description**: Short description of game here. Keep this short as it will generate the thumbnail
  in the index page.
- **link**: This will be the lower case version of the game name, with all spaces replaced with `-`.
  This will allow all of the relevant files within the repo to link the game to the different
  features.
