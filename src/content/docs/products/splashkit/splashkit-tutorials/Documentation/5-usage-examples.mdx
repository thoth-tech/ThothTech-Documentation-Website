...
[Planner Board Etiquette](/products/splashkit/splashkit-tutorials/onboarding/06-planner-board) for
...
Ensure while doing peer reviews that you also follow the [Planner Board Etiquette](/products/splashkit/splashkit-tutorials/onboarding/06-planner-board)
