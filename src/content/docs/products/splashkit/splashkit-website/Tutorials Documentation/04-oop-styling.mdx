...
This guide explains how to convert between top-level statements and object-oriented programming (OOP)
styles in C# for SplashKit tutorials. This guide is good to refer to when you need to convert code
between the two styles.

### Understanding the Differences Between Top-Level and OOP Styles in C#
