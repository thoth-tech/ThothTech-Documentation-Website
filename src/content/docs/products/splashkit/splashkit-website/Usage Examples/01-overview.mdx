...
2. **Develop a Demonstrative Program**:  
   Write a simple program to illustrate the function’s use. Focus on clarity and simplicity, ensuring
   that the code is easy to follow and that it showcases the function effectively.

3. **Write the Program in Multiple Languages**:  
   - **C++**: Implement the example with standard C++ practices.
   - **C#**: Provide both a version using top-level statements for simplicity and an Object-Oriented
   - (OOP) version for a more structured approach.
...
6. **Submit a Pull Request for Usage Examples**:  
   Follow the steps in the [Pull Requests for Usage Examples guide](/products/splashkit/splashkit-website/usage-examples/03-usage-pull-request).
   Use the provided PR template, describe your example clearly, and attach explanations and screenshots
   to the pull request.
