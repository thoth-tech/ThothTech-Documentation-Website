...
description: Learn how to update an existing usage example by adding a missing language to the Splashkit website.
sidebar:
...
This guide explains how to add a missing language to an existing usage example for the Splashkit website.
...
2. ### Writing the Program in the Missing Language
    ...
    **C# Version (Object-Oriented Programming):**
    ...
    to the language. This consistency helps readers understand the program's structure and function.
    If you need some help in understanding OOP and top level statements in C#, refer to the
    [OOP Styling](/products/splashkit/splashkit-website/tutorials-documentation/04-oop-styling) guide.
...
4. ### Adding the New Files to the Splashkit Starlight.io Repo
    ...
    For detailed naming and placement rules, refer to [CONTRIBUTING.md](https://splashkit.io/usage-examples/contributing/).

</Steps>

### Next Steps

After adding the files, follow the steps in [Usage Example Pull Requests](/products/splashkit/splashkit-website/usage-examples/03-usage-pull-request)
to submit for review. For peer review, refer to the [Peer Review Guide for Usage Examples](/products/splashkit/splashkit-website/usage-examples/04-usage-peer-review).
