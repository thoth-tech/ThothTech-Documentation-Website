...
2. [Accessibility Considerations](#accessibility-considerations)
   ...
   - [Disabling Animations and Smooth Transitions](#disabling-animations-and-smooth-transitions)
   - [Hover Effects and Visual Cues](#hover-effects-and-visual-cues)
   - [Colour Blindness Accessibility](#colour-blindness-accessibility)
3. [Typography](#typography)
   - [Astro Standards](#astro-standards)
...
- **Font**: Use a modern, readable font to maintain consistency across the website. We aim to follow
  the **Astro standards** for typography unless there is a specific design need to deviate.
