...
<details>
  ...
  - [Help hub session recording](https://deakin365-my.sharepoint.com/:v:/g/personal/s222332068_deakin_edu_au/ET47wDfbz59KqfBTUMciuUEBHUOBjvoo5rKxHw_hF2EWjQ?referrer=Teams.TEAMS-ELECTRON&referrerScenario=MeetingChicletGetLink.view.view)
</details>
...
<details>
  <summary>Can I communicate in General forums with other Thoth Tech contributors(any project)? </summary>

Indeed. Even if you are only involved in one Thoth Tech project, 
you will be informed about all the company's initiatives and receive updates on 
all latest developments via the Teams Channel. You may also get together with 
colleagues in the organization to get insight, pick up some tips, 
