...
<CardGrid>
  ...
  <LinkCard title="Trello" href="https://trello.com/b/nH5S3ecw/company-operations" />
</CardGrid>
...
that are relevant to improve the company's outlook and overall productivity. In the long term, we
aim to store documentations in a dedicated website (Starlight) to make it easy to push updates, new
